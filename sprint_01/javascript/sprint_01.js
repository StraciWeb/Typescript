...
const p_11 = parseInt(document.querySelector(".p-11").textContent);
console.log(p_11);
// Task 12
...
let n_13;
let s_13;
if (typeof document.querySelector(".p-13").textContent === "string") {
    s_13 = document.querySelector(".p-13").textContent;
    console.log(s_13);
}
else if (typeof document.querySelector(".p-13").textContent === "number") {
    n_13 = Number(document.querySelector(".p-13").textContent);
    console.log(n_13);
}
// Task 14
