...
const s_031 : string = "s_031";
const s_032 : string = "s_032";
...
let res_8 : any = p_08 + t_08;

document.querySelector(".out-8").textContent = res_8;
...
let p_10 : number = Number(document.querySelector(".p-10").textContent);
console.log(p_10);


// Task 11
// Создайте константу p_11 и получите в нее число из .p-11. Константу выведите в консоль.
const p_11 : number = parseInt(document.querySelector(".p-11").textContent);
console.log(p_11);


// Task 12
// Создайте константу p_12 и получите в нее число из .p-12. Константу выведите в консоль.
const p_12 : number = Number(document.querySelector(".p-12").textContent);
console.log(p_12);
...
if(isNaN(parseInt(document.querySelector(".p-13").textContent))) {
    s_13 = document.querySelector(".p-13").textContent;
    console.log(s_13);
}else if (!isNaN(parseInt(document.querySelector(".p-13").textContent))){
    n_13 = parseInt(document.querySelector(".p-13").textContent);
    console.log(n_13);
}
...
let b_19 : boolean = Boolean(document.querySelector(".p-19").textContent);
console.log(b_19);

// Тask 20
// Создайте переменную b_20, тип boolean и поместите в нее значение из .p-20 (число из .p-20). Выведите в консоль.
let b_20 : boolean = Boolean(Number(document.querySelector(".p-20").textContent))
console.log(document.querySelector(".p-20").textContent);
console.log(b_20);
