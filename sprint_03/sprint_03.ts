...
function f01 () : void {
   s_1 = (<HTMLInputElement>document.querySelector(".i-1")).value;
   console.log(s_1);
}
...
let res_2 : number; 
function f02 () : void {
    res_2 = +(<HTMLInputElement>document.querySelector(".i-2")).value
    console.log(res_2);
}
...
// тут объявляем min_4
let min_4 : number;
let n_41 : number = +(document.querySelector(".i-41") as HTMLInputElement).value
let n_42 : number = Number((document.querySelector(".i-42") as HTMLInputElement).value)
...
let n_51  = document.querySelector(".i-51") as HTMLInputElement;
let n_52  = document.querySelector(".i-52") as HTMLInputElement;
...
let n_61 = parseInt((<HTMLInputElement>document.querySelector(".i-61")).value);
let n_62 = parseInt((<HTMLInputElement>document.querySelector(".i-62")).value);
...
let n_71 : string = (<HTMLInputElement>document.querySelector(".i-71")).value;
let n_72 : string = (<HTMLInputElement>document.querySelector(".i-72")).value;

function f07 () : void {
    if(n_71.length > n_72.length) max_7.textContent = n_71;
    else max_7.textContent = n_72;
}
...
function f08 () : void {
    let s_81 = (<HTMLInputElement>document.querySelector(".s-8")).value
...
function f09 () : void {
    (<HTMLInputElement>document.querySelector(".s-9")).value = String(val_9);
...
function f10 () : void {
    let r_10 = <HTMLInputElement>document.querySelector(".ch-10");
    let r_11 = <HTMLInputElement>document.querySelector(".out-10");
    if(r_10.checked) {
        res_10 = true;
...
function f11 () : void {
    let r_12 = <HTMLInputElement>document.querySelector(".ch-11");
...
function f12 () : void {
   let r_14 = <HTMLInputElement>document.querySelector(".ch-12");
   if(res_12 === 1)  r_14.checked = true;
   else r_14.checked = false;
}
...
function f13 () : void {
    let r_15 : number = parseInt((<HTMLInputElement>document.querySelector(".i-13")).value);
...
function f14 () : void {
    let res_144 : number = parseInt((<HTMLInputElement>document.querySelector(".i-14")).value);
...
function f16 () : void {
    let res_166 = (<HTMLInputElement>document.querySelector(".i-16")).value;
...
let res_17 : boolean = true;

function f17 () : void {
    let res_177 = <HTMLInputElement>document.querySelector(".i-17");
    if(res_17 === true) res_177.disabled = true;
    else res_177.disabled = false;
}
...
// тут объявляем s_19
let s_19 : string;
let n_19 : number = parseInt((<HTMLInputElement>document.querySelector(".i-19")).value);
...
// тут объявляем s_20
let s_20 : number = null;

function f20 () : void {
    let res_20 = parseInt((<HTMLInputElement>document.querySelector(".i-20")).value);
