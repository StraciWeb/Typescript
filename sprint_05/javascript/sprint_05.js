...
const f05 = (str) => {
    return parseInt(document.querySelector(str).value);
};
...
const f06 = () => {
    const str_060 = document.querySelector(".i-61").value;
    const str_061 = document.querySelector(".i-62").value;
    if (str_060 > str_061)
        document.querySelector(".out-6").textContent = str_060;
    else
        document.querySelector(".out-6").textContent = str_061;
};
...
const f10 = () => {
    angle += 30;
    return document.querySelector(".out-10").style.transform = `rotate(${angle}deg)`;
};
