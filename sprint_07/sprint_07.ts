...
const f09 = (element: TsTypes) : (number | string | boolean) => {
    if(element === TsTypes["number"]) return 1;
    if(element === TsTypes["string"]) return "1";
    if(element === TsTypes["boolean"]) return true;
}
