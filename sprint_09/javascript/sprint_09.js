...
class Paragraph_05 {
    ...
    render() {
        ...
        if (this.bold) {
            ...
            p1.textContent = this.text.charAt(0).toUpperCase() + this.text.slice(1);
        return p1;
    }
}
// Для проверки кода снимите комментарий ниже
...
class CellOperator {
    ...
    operator() {
        if (this.code === '050' || this.code === '066' || this.code === '095' || this.code === '0999')
            return "Vodafone";
        if (this.code === '063' || this.code === '073' || this.code === '093')
            return "Life";
        if (this.code === '067' || this.code === '068' || this.code === '096' || this.code === '98')
            return "Kyivstar";
        else
            return "";
    }
